    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="jumbotron bg-dark">
                <br>
UPDATE PRODUCT
<form:form action="updateProduct/${product.getId()}" modelAttribute="productToUpDate" method="POST">
    <table>
        <tbody>
        <tr>
            <td><label>nazwa:</label></td>
            <td><form:input path="nazwa" value="${product.nazwa}"/></td>
        </tr>
        <tr>
            <td><label>opis:</label></td>
            <td><form:input path="opis" value="${product.opis}"/></td>
        </tr>
        <tr>
            <td><label>cena:</label></td>
            <td><form:input path="cena" value="${product.cena}"/></td>
        </tr>
